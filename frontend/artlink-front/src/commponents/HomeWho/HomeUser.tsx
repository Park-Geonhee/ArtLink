    ...
    <>
      ...
      <div className="BigBtnBox2">
        ...
        <div className={Styles.startbtnBody}>
          <Link to="/art-memory" style={{ textDecoration: "none"}} className={Styles.startbtn}>
        ...
        {/* Menu : My Page */}
        <div className={Styles.startbtnBody}>
          <Link to="/mypage/user" style={{ textDecoration: "none"}} className={Styles.startbtn}>
            <div style={{margin:"auto"}}>
              <p className={Styles.innerIcon}>{"My Page"}</p>
              <p className={Styles.innerIcon2}>{"Read and Change Your Info"}</p>
            </div>
          </Link>
        </div>
      </div>
